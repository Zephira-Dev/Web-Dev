...
namespace NeverEndingVoid.Mainmenu
{
    public class MainMenu : ModMenu
    {

        public override string DisplayName => "Doomsday Clock";

        public override Asset<Texture2D> Logo => ModContent.Request<Texture2D>("NeverEndingVoid/Mainmenu/NEV");
        public override Asset<Texture2D> SunTexture => ModContent.Request<Texture2D>("NeverEndingVoid/Mainmenu/blank");
        public override Asset<Texture2D> MoonTexture => ModContent.Request<Texture2D>("NeverEndingVoid/Mainmenu/blank");

        public override int Music => MusicLoader.GetMusicSlot(Mod, "Content/Sounds/Music/DarkRealm");
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("NeverEndingVoid/Mainmenu/Darkness").Value;
